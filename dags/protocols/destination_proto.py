...
from utils import RunResult, ValidationResult, ProtocolSchema
...
class DestinationProto(Protocol):
  ...
  def schema() -> Optional[ProtocolSchema]:
    ...
    TODO(b/aaa): Change documentation
    Returns:
      A config dict, preferably generated by defining a schema class
      that inherits from Pydantic BaseModel and calling the
      schema_json method. See more details in:
      https://docs.pydantic.dev/2.0/usage/json_schema/
    """
    ...
